...
func TestQuickLastFeedingReturnsLatestWithTimezoneFields(t *testing.T) {
	...
	rec := performRequest(
		...
		newTestRouter(t),
		http.MethodGet,
		"/api/v1/quick/last-feeding?baby_id="+fixture.BabyID+"&tz_offset=%2B09:00",
		signToken(t, fixture.UserID, nil),
		nil,
		nil,
	)
...
func TestQuickLandingSnapshotIncludesExpandedOpenEventFields(t *testing.T) {
	...
	rec := performRequest(
		...
		newTestRouter(t),
		http.MethodGet,
		"/api/v1/quick/landing-snapshot?baby_id="+fixture.BabyID+"&tz_offset=%2B00:00",
		signToken(t, fixture.UserID, nil),
		nil,
		nil,
	)
...
func TestQuickLandingSnapshotRangeWeekReturnsAveragesAndGraph(t *testing.T) {
	...
	rec := performRequest(
		...
		newTestRouter(t),
		http.MethodGet,
		"/api/v1/quick/landing-snapshot?baby_id="+fixture.BabyID+"&range=week&tz_offset=%2B00:00",
		signToken(t, fixture.UserID, nil),
		nil,
		nil,
	)
